...
const Menu = () => {
    ...
    return (
        <div className="pb-2 sm:pb-8 2xl:pt-20 lg:pt-10 pt-5 2xl:pb-10 background-black px-4 lg:px-6 md:px-8 text-white flex flex-col justify-center items-center "> 
