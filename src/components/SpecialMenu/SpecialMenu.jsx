...
const SpecialMenu = () => {
    ...
    return (
        <div className="2xl:pt-0 background-black px-4 text-white pb-5 pt-10">
        ...
        <div className=' 2xl:mt-4 lg:flex-row text-white flex flex-col justify-center'> 
            ...
            <div className='2xl:py-0 2xl:w-2/5 xl:w-2/5 lg:w-2/5 lg:px-0 lg:flex lg:order-none images-menu py-4 order-1 flex justify-center'> 
            <img src={images.menu} alt="img menu" className="w-3/5 lg:w-full xl:w-4/5" />
            </div>
